/**
 * Main Layout - Wraps all pages with head metadata, navigation, and footer.
 * Provides consistent structure across the entire site.
 */
  ...
  return (
    <Box as="main" pb={8}>
      <Head>
        ...
        <meta name="description" content="Jeffrey Fernandez - Software Engineer Portfolio" />
